...
- Fairness-aware and trustworthy AI systems  
- Learning under heterogeneous and unreliable client participation  
- Semantic communication for distributed intelligence  
- IoT- and edge-oriented federated learning systems  
- Scalable and privacy-aware machine learning infrastructures  
...
- **Muhammad Ameen**, Pengfei Wang, Weijian Su, Xiaopeng Wei, and Qiang Zhang,  
  *Speed Up Federated Unlearning with Temporary Local Models*,  
  **IEEE Transactions on Sustainable Computing**, 2025.

- Weijian Su, Pengfei Wang, Zhiyi Wang, **Muhammad Ameen**, et al.,  
  *F2UL: Fairness-aware Federated Unlearning for Data Trading*,  
  **IEEE Transactions on Mobile Computing**, 2024.

- Zhenwei Wang, Pengfei Wang, **Muhammad Ameen**, et al.,  
  *Inverse Feature Consistency Federated Unlearning for Vision-Language Models*,  
...
- Pengfei Wang, **Muhammad Ameen**, et al.,  
  *Eliminating Poor-quality Data Impacts from Multiple Participants with Federated Unlearning*,  
  **IEEE/ACM International Symposium on Quality of Service (IWQoS)**, 2025.

- Zishuo Song, Yuzhu Pan, Mingshu Zhao, **Muhammad Ameen**, et al.,  
